...
class huoshan implements DnsInterface
{
    ...
    public function getDomainRecords(
        ...
        if ($data) {
            ...
            foreach ($data['Records'] as $row) {
                if ($row['Type'] == 'MX') {
                    [$row['MX'], $row['Value']] = explode(' ', $row['Value']);
                }
                $list[] = [
    ...
    public function getDomainRecordInfo($RecordId)
    {
        ...
        if ($data) {
            ...
            if ($data['Type'] == 'MX') {
                [$data['MX'], $data['Value']] = explode(' ', $data['Value']);
            }
            return [
    ...
    public function getMinTTL()
    {
        $domainInfo = $this->getDomainInfo();
        if ($domainInfo) {
            return $this->getTradeInfo($domainInfo['TradeCode'])['ttl'];
        }
        return false;
    }
